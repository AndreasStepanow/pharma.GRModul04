sap.ui.define([
		...
		return BaseObject.extend("de.arvato.GRModul04.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias de.arvato.model.ListSelector
			 */
			 ...
			 * @return {de.arvato.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
